...
Question.create(question: "How should you load the dishwahs",id: 1, user_id: 1)
Question.create(question: "Dunkind or Starbucks?", id: 2, user_id: 2)
Question.create(question: "Homeschool or Public School?", id: 3, user_id: 3)
Question.create(question: "Mcdonalds or Burger King?", id: 4, user_id: 4)
Question.create(question: "DO you like your friends boyfriend?", id: 5, user_id: 5)
